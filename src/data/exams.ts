...
const examRecords: ExamGuide[] = [
  {
    ...
    "preparationStrategy": [
      {
        "phase": "Диагностика",
        "focus": "Определите стартовый уровень и целевой балл IELTS."
      },
      {
        "phase": "База",
  ...
  },
  {
    ...
    "preparationStrategy": [
      {
        "phase": "Выбор уровня",
        "focus": "Выберите подходящую квалификацию по официальным пробным заданиям."
      },
      {
        "phase": "Языковая база",
        "focus": "Систематизируйте грамматику, словообразование и устойчивые сочетания."
      },
      {
        "phase": "Формат",
        "focus": "Отработайте каждую часть и изучите критерии оценивания письма и устной речи."
      },
      {
        "phase": "Репетиция",
