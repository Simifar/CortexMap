...
export const metadata = createRouteMetadata({ title: 'Экзамены по английскому языку', description: 'Формат, шкалы оценивания и материалы для подготовки к IELTS, TOEFL iBT и экзаменам Cambridge English.', path: '/exams' });
